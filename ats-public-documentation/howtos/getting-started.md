...
![](version-1/attachments/getting-started/my-projects.png)

To create a new project, follow these steps:

1. Click **Add project/Create new project**, which opens the *Create new project/library* page:

      ![](version-1/attachments/getting-started/create-new-project.png)
...
3.  Click **Save & Open** at the bottom of the page to open the **Project Dashboard**.
      ...
      ![](version-1/attachments/getting-started/project-dashboard-empty.png)
...
![](version-1/attachments/getting-started/configuration-getting-started.png)
...
1. Click **New** in the top bar, which opens the **Selenium hub** dialog box:
      ...
      ![](version-1/attachments/getting-started/selenium-hub-dialog.png)
...
1. Click **New** in the top bar, which opens the **Application** dialog box.
      ...
      ![](version-1/attachments/getting-started/application-dialog.png)
...
![](version-1/attachments/getting-started/repository-empty.png)
...
3. Enter a clear description for your test case. In case others may need to know what your test case does, use a template to make sure all aspects of the case are described clearly.
      ...
      ![](version-1/attachments/getting-started/create-new-test-case.png)
...
![](version-1/attachments/getting-started/test-case-page.png)
...
![](version-1/attachments/getting-started/ats-information-dialog.png)
...
2. You can now open the Mendix application you want to test in another tab of the browser and start testing the application manually. The test steps you take will now be recorded and saved in the chosen test case.
      ...
      ![](version-1/attachments/getting-started/recording-session-cp.png)
...
3.  Click **Save** to save your actions for this event.
      ...
      **Action mapping** | This shows all the available actions for this event. Click  **Select** if you want to choose a different action.
      ...
      ![](version-1/attachments/getting-started/recorded-test-steps.png)
...
![](version-1/attachments/getting-started/data-set-test-case.png)
...
![](version-1/attachments/getting-started/show-usages-test-case.png)
...
![](version-1/attachments/getting-started/stories-test-case.png)
...
3. Enter a clear description for your test suite. Others may need to know what your test suite does. It might be handy to use a template to make sure all aspects of the suite are present.
      ...
      ![](version-1/attachments/getting-started/create-new-test-suite.png)
...
![](version-1/attachments/getting-started/test-suite-page.png)
...
![](version-1/attachments/getting-started/select-test.png)
...
![](version-1/attachments/getting-started/show-usages-test-suite.png)
...
![](version-1/attachments/getting-started/stories-test-suite.png)

## 6 Run Configuration

When you click **Run** in the upper-right corner of your test case, the **Select Run Configuration** page will open.

![](version-1/attachments/getting-started/run-configuration.png)
...
![](version-1/attachments/getting-started/monitoring-results-pending.png)
...
Now you finished the getting started guide for ATS. Please check our [how-to's](../howtos/index) and [best practice](../bestpractices/index) for more information.
