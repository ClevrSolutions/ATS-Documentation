...
{{% alert type="info" %}}
Keep the [guidelines for creating a custom action](../bestpractices/guidelines-custom-action-2) in mind while creating action parameters. 
{{% /alert %}}
...
1.  Configure the **Widget Name** input parameter like this:
    ...
    ![](attachments/create-unsupported-widget/cab-03-textbox/widget-name-parameter.png)

2.  Configure the **Value** input parameter like this:

    ![](attachments/create-unsupported-widget/cab-03-textbox/value-parameter.png)

3.  Configure the **Search Context** input parameter like this:

    ![](attachments/create-unsupported-widget/cab-03-textbox/search-context-parameter.png)
