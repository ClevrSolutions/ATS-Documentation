...
### Set Checkbox Set Selector Value<a name="SetCheckboxSetSelectorValue"></a>
##### Function Key
...
##### Return value
None
### Set Checkbox Set Selector Value (all)<a name="SetCheckboxSetSelectorValueAll"></a>
##### Function Key
...
| [Get Active Tab Name](#GetActiveTabName) | Returns the name of the active tab page as specified in the modeler. This is not the same as the caption of the tab which is shown in the browser. |
...
### Get Validation Message<a name="GetValidationMessage"></a>
##### Function Key
...
##### Return value
_String_
### Get Value<a name="GetValue"></a>
##### Function Key
GetValue
##### Description
Returns the current value of all supported widgets.   
Supported widgets: text box, text area, drop down, radio button, date picker, reference selector,
search input text, search input drop down, label, input reference set selector, OnChange Inputbox,
BooleanSlider, BootstrapWysiwygEditor (Bootstrap RTE), CKEditor For Mendix, InputReferenceSelector
RadiobuttonList, Switch, AutoComplete, Format String, Custom String.
##### Input Parameters
| Name | Key | Datatype | Description | 
| ---- | --- | -------- | ----------- |
| Widget Name | WidgetName | String | _Required_ The name that was assigned in the modeler to that widget, e.g. 'textBox1'. Use the 'ATS Helper' bookmarklet to see the names of different widgets in you page. For further qualification you can additionally put in the names of surrounding widgets  separated by a single space, e.g. 'dataView1 textBox1'. |
...
### Get Row Cell Value<a name="GetRowCellValue"></a>
##### Function Key
GetRowCellValue
##### Description
...
### Get Visible Item/Row Count<a name="GetVisibleItemRowCount"></a>
##### Function Key
...
##### Return value
_Integer_ Number of Rows/Items.
### Get Checkbox Value<a name="GetCheckboxValue"></a>
##### Function Key
GetCheckboxValue
##### Description
...
### Get Checkbox Set Selector Value<a name="GetCheckboxSetSelectorValue"></a>
##### Function Key
...
##### Return value
_Boolean_ If true then checks the check box/radio button, otherwise clears it.
### Get Simple Checkbox Set Selector Value<a name="GetSimpleCheckboxSetSelectorValue"></a>
##### Function Key
...
##### Return value
_Boolean_ If true then checks the check box/radio button, otherwise clears it.
### Get Dialog Message Text<a name="GetDialogMessageText"></a>
##### Function Key
...
### Assert Validation Message<a name="AssertValidationMessageNegetable"></a>
##### Function Key
...
##### Return value
None
### Assert Active Tab Name<a name="AssertActiveTabNameNegetable"></a>
##### Function Key
...
| ---- | --- | -------- | ----------- |
| Widget Name | WidgetName | String | _Required_ The name that was assigned in the modeler to that widget, e.g. 'textBox1'. Use the 'ATS Helper' bookmarklet to see the names of different widgets in you page. For further qualification you can additionally put in the names of surrounding widgets  separated by a single space, e.g. 'dataView1 textBox1'. |
| Active Tab Name | ActiveTabName | String | _Required_ The name of a tab page as it is specified in the modeler. This is not the same as the caption of the tab which is shown in the browser. |
| Search Context | SearchContext | String | _Optional_ Limits the search of the widget to this web element and its children. Can be used to dynamically restrict the search at runtime,  for instance to a certain template grid item. |
| Negate | NegateParameter | Boolean | _Required_ Negetes the asssert |

##### Return value
None
### Assert Checkbox Value<a name="AssertCheckboxValueNegetable"></a>
##### Function Key
...
Supported widgets: text box, text area, drop down, radio button, date picker, reference selector,
search input text, search input drop down, label, input reference set selector, OnChange Inputbox, BooleanSlider,
BootstrapWysiwygEditor (Bootstrap RTE), CKEditor For Mendix, InputReferenceSelector, RadiobuttonList, 
Switch, AutoComplete, Format String, Custom String.
##### Input Parameters
| Name | Key | Datatype | Description | 
| ---- | --- | -------- | ----------- |
| Widget Name | WidgetName | String | _Required_ The name that was assigned in the modeler to that widget, e.g. 'textBox1'. Use the 'ATS Helper' bookmarklet to see the names of different widgets in you page. For further qualification you can additionally put in the names of surrounding widgets  separated by a single space, e.g. 'dataView1 textBox1'. |
...
##### Return value
None
### Dropdown has Option<a name="DropdownHasOption"></a>
##### Function Key
DropdownHasOption
##### Description
...
##### Return value
None
### Assert Checkbox Set Selector Value<a name="AssertCheckboxSetSelectorValueNegetable"></a>
##### Function Key
...
##### Return value
None
### Assert Simple Checkbox Set Selector Value<a name="AssertSimpleCheckboxSetSelectorValueNegetable"></a>
##### Function Key
...
##### Return value
None
### Assert Grid Selector Value<a name="AssertGridSelectorValueNegetable"></a>
##### Function Key
...
### Find/Assert Widget Child Node<a name="FindWidgetChildNodeNegetable"></a>
##### Function Key
...
### Find/Assert Menu Item<a name="FindAssertMenuItemNegetable"></a>
##### Function Key
...
### Find/Assert DataGrid Row<a name="FindAssertDataGridRowNegetabke"></a>
##### Function Key
...
| ---- | --- | -------- | ----------- |
| Widget Name | WidgetName | String | _Required_ The name that was assigned in the modeler to that widget, e.g. 'textBox1'. Use the 'ATS Helper' bookmarklet to see the names of different widgets in you page. For further qualification you can additionally put in the names of surrounding widgets  separated by a single space, e.g. 'dataView1 textBox1'. |
| Column 1 Name | Column1Name | String | _Optional_ Name of the column as assigned in the Mendix Modeler. This is not the caption of the column. |
...
| Column 2 Name | Column2Name | String | _Optional_ Name of the column as assigned in the Mendix Modeler. This is not the caption of the column. |
...
| Column 3 Name | Column3Name | String | _Optional_ Name of the column as assigned in the Mendix Modeler. This is not the caption of the column. |
...
### Find/Assert Item/Row (by index)<a name="FindItemRowNegetable"></a>
##### Function Key
...
Use the 'Find/Assert DataGrid Row', 'Find Item/Row' or 'Find Item/Row (by child element)'
to get a reference to the correct web element.
### Find Item/Row (by child element)<a name="FindItemRowByChildElement"></a>
##### Function Key
...
##### Return value
_WebElement_ Menu Item as a Web Element.
### Find/Assert Selected Item/Row<a name="FindSelectedItemRowNegetable"></a>
##### Function Key
...
Use the 'Find/Assert DataGrid Row', 'Find Item/Row' or 'Find Item/Row (by child element)'
to get a reference to the correct web element.
### Find/Assert Widget<a name="FindAssertWidgetNegetable"></a>
##### Function Key
...
### Find/Assert Checkbox Set Selector<a name="FindCheckboxSetSelectorNegetable"></a>
##### Function Key
...
##### Return value
_WebElement_
### Find Checkbox Set Selector (all)<a name="FindCheckboxSetSelectorAll"></a>
##### Function Key
...
##### Return value
_WebElement_
### Find/Assert Grid Selector<a name="FindGridSelectorNegetable"></a>
##### Function Key
...
### Click DataGrid Row<a name="ClickDataGridRow"></a>
##### Function Key
ClickDataGridRow
##### Description
...
##### Return value
None
### Click Widget<a name="ClickWidget"></a>
##### Function Key
ClickWidget
##### Description
...
ClickWidgetButton
##### Description
Clicks on one of the following special widget buttons: refresh, load more,
clear search field (list view), go to, add (reference selector).
##### Input Parameters
| Name | Key | Datatype | Description | 
| ---- | --- | -------- | ----------- |
| Widget Name | WidgetName | String | _Required_ The name that was assigned in the modeler to that widget, e.g. 'textBox1'. Use the 'ATS Helper' bookmarklet to see the names of different widgets in you page. For further qualification you can additionally put in the names of surrounding widgets  separated by a single space, e.g. 'dataView1 textBox1'. |
...
##### Return value
None
### Close GroupBox<a name="CloseGroupBox"></a>
##### Function Key
CloseGroupBox
##### Description
Closes a group box.
...
##### Return value
None
### Open GroupBox<a name="OpenGroupBox"></a>
##### Function Key
OpenGroupBox
##### Description
Opens a group box.
...
##### Return value
None
### Sort DataGrid<a name="SortDataGrid"></a>
##### Function Key
SortDataGrid
##### Description
...
##### Return value
None
### Toggle BooleanSlider Value<a name="ToggleBooleanSliderValue"></a>
##### Function Key
...
##### Return value
None
### Close Dialog<a name="CloseDialog"></a>
##### Function Key
CloseDialog
##### Description
...
##### Return value
None
### Confirm Dialog<a name="ConfirmDialog"></a>
##### Function Key
ConfirmDialog
##### Description
...
##### Return value
None
### Set ListView Search<a name="SetListViewSearch"></a>
##### Function Key
SetListViewSearch
##### Description
...
##### Return value
None
### Get Current Page Title<a name="GetCurrentPageTitle"></a>
##### Function Key
GetCurrentPageTitle
##### Description
...
### Assert Current Page<a name="AssertCurrentPageNegatable"></a>
##### Function Key
...
##### Return value
None
### Open Mendix Application<a name="OpenMendixApplication"></a>
##### Function Key
...
| [Element matches Selector](#ElementMatchesSelector) | Returns whether the given element matches a selector e.g. :contains('foo') or :first-child. Check out the reference guide for a complete list of possible selectors. |
...
##### Return value
_WebElement_
### Find/Assert Element<a name="FindElementNegetable"></a>
##### Function Key
...
##### Return value
_WebElement_ Use one of the 'Find element by X' functions to get this object.
### Find/Assert Element by Sizzle<a name="FindElementBySizzleNegetable"></a>
##### Function Key
...
##### Return value
_String_ identifier of active window
### Get Selected Option Index<a name="GetSelectedOptionIndex"></a>
##### Function Key
...
##### Return value
_String_ The value to set.
### Is Element Displayed<a name="IsElementDisplayed"></a>
##### Function Key
IsElementDisplayed
##### Description
...
##### Return value
None
### Switch to Window<a name="SwitchToWindow"></a>
##### Function Key
SwitchToWindow
##### Description
...
Returns the window handle, i.e. identifier, of the new active window.
##### Input Parameters
None

##### Return value
_String_ identifier of active window
### Set Page Load Timeout <a name="SetPageLoadTimeout"></a>
##### Function Key
SetPageLoadTimeout
##### Description
...
##### Return value
None
### Select Option By Index<a name="SelectOptionByIndex"></a>
##### Function Key
SelectOptionByIndex
##### Description
...
##### Return value
None
### Click Coordinates<a name="ClickCoordinates"></a>
##### Function Key
ClickCoordinates
##### Description
...
##### Return value
None
### Doubleclick<a name="Doubleclick"></a>
##### Function Key
Doubleclick
##### Description
...
##### Return value
None
### Focus and Clear Element Value<a name="FocusAndClearElementValue"></a>
##### Function Key
...
##### Return value
None
### Focus WebElement<a name="FocusWebElement"></a>
##### Function Key
FocusWebElement
##### Description
...
##### Return value
None
### Click/Doubleclick<a name="ClickDoubleclick"></a>
##### Function Key
ClickDoubleclick
##### Description
...
##### Return value
None
### Accept Browser Alert<a name="AcceptBrowserAlert"></a>
##### Function Key
AcceptBrowserAlert
##### Description
...
##### Return value
None
### Clear WebElement<a name="ClearWebElement"></a>
##### Function Key
ClearWebElement
##### Description
...
##### Return value
None
### Dismiss Browser Alert<a name="DismissBrowserAlert"></a>
##### Function Key
DismissBrowserAlert
##### Description
...
##### Return value
None
### Concatenate String<a name="ConcatenateString"></a>
##### Function Key
ConcatenateString
##### Description
...
##### Return value
_String_
### Is not Null<a name="IsNotNull"></a>
##### Function Key
IsNotNull
##### Description
...
##### Return value
_Boolean_
### Assert containsString<a name="AssertContainsStringNegetable"></a>
##### Function Key
...
##### Return value
None
### Assert equalTo<a name="AssertEqualToNegetable"></a>
##### Function Key
...
##### Return value
None
### Assert equalToIgnoringCase<a name="AssertEqualToIgnoringCaseNegetable"></a>
##### Function Key
...
##### Return value
None
### Assert equalToIgnoringWhiteSpace<a name="AssertEqualToIgnoringWhiteSpaceNegetable"></a>
##### Function Key
...
* any remaining whitespace, appearing within either string, is collapsed to a single space.
For example: '   my\tfoo  bar ' is equal to ' my  foo bar', ignoring whitespace.
##### Input Parameters
| Name | Key | Datatype | Description | 
| ---- | --- | -------- | ----------- |
| Object 1 | Object1 | Any | _Required_  |
...
##### Return value
None
### Assert greaterThan<a name="AssertGreaterThan"></a>
##### Function Key
AssertGreaterThan
##### Description
...
##### Return value
None
### Assert greaterThanOrEqualTo<a name="AssertGreaterThanOrEqualTo"></a>
##### Function Key
...
##### Return value
None
### Assert lessThan<a name="AssertLessThan"></a>
##### Function Key
AssertLessThan
##### Description
...
##### Return value
None
### Assert lessThanOrEqualTo<a name="AssertLessThanOrEqualTo"></a>
##### Function Key
...
##### Return value
None
### Assert startsWith<a name="AssertStartsWithNegetable"></a>
##### Function Key
...
##### Return value
None
### Assert XML equivalent<a name="AssertXMLEquivalentNegetable"></a>
##### Function Key
...
##### Return value
None
### Return First Valid Boolean Object<a name="ReturnFirstValidBoolean"></a>
##### Function Key
...
##### Return value
_Boolean_
### Return First Valid Integer Object<a name="ReturnFirstValidInteger"></a>
##### Function Key
...
##### Return value
_Integer_
### Return First Valid String<a name="ReturnFirstValidString"></a>
##### Function Key
...
##### Return value
_String_
### Return First Valid WebElement<a name="ReturnFirstValidWebElement"></a>
##### Function Key
...
##### Return value
_WebElement_
### RegExp Match<a name="RegExpMatch"></a>
##### Function Key
RegExpMatch
##### Description
...
##### Return value
_String_
### Set Return Value<a name="SetReturnValue"></a>
##### Function Key
SetReturnValue
##### Description
...
### Generate GUID<a name="GenerateGUID"></a>
##### Function Key
GenerateGUID
##### Description
...
##### Return value
_String_ GUID
### Random Number<a name="RandomNumber"></a>
##### Function Key
RandomNumber
##### Description
...
### Random String<a name="RandomString"></a>
##### Function Key
RandomString
##### Description
...
### Get Current DateTime String<a name="GetCurrentDateTimeString"></a>
##### Function Key
