...
Starting with this release it is possible to test web applications on real mobile devices. 
<<<<<<< HEAD

Please refer to mobile section[LINK HERE] in the ATS reference guide for more details.

* drop downs are not set via the native dialog
=======
Please refer to mobile section in the ATS reference guide for more details.
>>>>>>> e90d9da20f1c4ca5f7113c310fefdf0e760e400d
...
<<<<<<< HEAD
In order to make it easier to read and understand the results of a test run we are making some changes. These are the main changes:
=======
